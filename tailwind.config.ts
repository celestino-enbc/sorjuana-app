...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Coolors palette: Shadow Grey, Snow, Olive Leaf, Black, Bright Snow
        primary: {
          deep: "#050504",
          DEFAULT: "#2A2827",
          light: "#3D3A38",
      ...
      fontFamily: {
        ...
        body: ["var(--font-proza-libre)", "system-ui", "sans-serif"],
        accent: ["var(--font-cormorant-garamond)", "Georgia", "serif"],
      },
      fontSize: {
